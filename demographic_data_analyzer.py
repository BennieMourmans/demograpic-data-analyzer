...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country = ((df[df['salary'] == '>50K'].groupby('native-country')['native-country'].count()) / (df['native-country'].value_counts())).idxmax()
    highest_earning_country_percentage = round((((df[df['salary'] == '>50K'].groupby('native-country')['native-country'].count()) / (df['native-country'].value_counts()) *100).max()), 1)
